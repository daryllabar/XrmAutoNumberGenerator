...
namespace DLaB.XrmAutoNumberGenerator.Entities
{
	...
	public partial class SdkMessageProcessingStep : Microsoft.Xrm.Sdk.Entity, System.ComponentModel.INotifyPropertyChanging, System.ComponentModel.INotifyPropertyChanged
	{
		...
		public System.Nullable<DLaB.XrmAutoNumberGenerator.Entities.SdkMessageProcessingStepState> StateCode
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				...
				if ((optionSet != null))
				{
					return ((DLaB.XrmAutoNumberGenerator.Entities.SdkMessageProcessingStepState)(System.Enum.ToObject(typeof(DLaB.XrmAutoNumberGenerator.Entities.SdkMessageProcessingStepState), optionSet.Value)));
				}
				else
				{
					return null;
		...
		public DLaB.XrmAutoNumberGenerator.Entities.PluginType plugintype_sdkmessageprocessingstep
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntity<DLaB.XrmAutoNumberGenerator.Entities.PluginType>("plugintype_sdkmessageprocessingstep", null);
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
				this.OnPropertyChanging("plugintype_sdkmessageprocessingstep");
				this.SetRelatedEntity<DLaB.XrmAutoNumberGenerator.Entities.PluginType>("plugintype_sdkmessageprocessingstep", null, value);
		...
		public DLaB.XrmAutoNumberGenerator.Entities.PluginType plugintypeid_sdkmessageprocessingstep
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntity<DLaB.XrmAutoNumberGenerator.Entities.PluginType>("plugintypeid_sdkmessageprocessingstep", null);
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
				this.OnPropertyChanging("plugintypeid_sdkmessageprocessingstep");
				this.SetRelatedEntity<DLaB.XrmAutoNumberGenerator.Entities.PluginType>("plugintypeid_sdkmessageprocessingstep", null, value);
		...
		public DLaB.XrmAutoNumberGenerator.Entities.SdkMessageFilter sdkmessagefilterid_sdkmessageprocessingstep
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntity<DLaB.XrmAutoNumberGenerator.Entities.SdkMessageFilter>("sdkmessagefilterid_sdkmessageprocessingstep", null);
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
				this.OnPropertyChanging("sdkmessagefilterid_sdkmessageprocessingstep");
				this.SetRelatedEntity<DLaB.XrmAutoNumberGenerator.Entities.SdkMessageFilter>("sdkmessagefilterid_sdkmessageprocessingstep", null, value);
		...
		public DLaB.XrmAutoNumberGenerator.Entities.SdkMessage sdkmessageid_sdkmessageprocessingstep
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntity<DLaB.XrmAutoNumberGenerator.Entities.SdkMessage>("sdkmessageid_sdkmessageprocessingstep", null);
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
				this.OnPropertyChanging("sdkmessageid_sdkmessageprocessingstep");
				this.SetRelatedEntity<DLaB.XrmAutoNumberGenerator.Entities.SdkMessage>("sdkmessageid_sdkmessageprocessingstep", null, value);
